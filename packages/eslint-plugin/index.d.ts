...
declare const _default: {
    rules: {
        readonly "no-template-literals": {
            ...
            readonly defaultOptions: import("./rule/no-irregular-whitespace").IOptions;
            readonly create: (context: import("@typescript-eslint/experimental-utils/dist/ts-eslint/Rule").RuleContext<string, [import("./rule/no-irregular-whitespace").IOptions]>) => {
                "Program:exit"?: () => void;
